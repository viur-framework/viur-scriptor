			  ...
			  <sl-tab-panel name="data">
				...
				<div class="data-detail-scroll">
					...
					<sl-button class="data-btn"
							...
							size="medium"
					>
						<sl-avatar initials="U" slot="prefix"  shape="rounded">
						</sl-avatar>
						User
					</sl-button>
					...
					<sl-button class="data-btn"
							...
							size="medium"
					>
						<sl-avatar initials="F" slot="prefix"  shape="rounded">
						</sl-avatar>
						File
					</sl-button>
				</div>
...
export default {
  name: 'Home',
  components: {Api, CodeTab, CodeEditor, FileTree, LoadingSpinner, VueJsonPretty, ModuleDetails},
  setup() {
	const executor = ref();
	const log = ref([]);
	const logItems = ref([]);
